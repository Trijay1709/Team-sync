          ...
          server?.members?.map((member)=>(
            <div key={member.id} className="flex items-center gap-x-2 mb-6 ">
              ...
              <div className="flex-col flex gap-y-1">
                <div className="text-xs font-semibold flex items-center gap-x-2">{member.profile.name} {roleIconMap[member.role]}</div>
                    ...
                    <DropdownMenuContent side="left" >
                      <DropdownMenuSub>
                        ...
                        className="flex items-center">
                          <ShieldQuestion className="h-4 w-4 text-zinc-500 mr-2"/>
                          <span>Role</span>
                        </DropdownMenuSubTrigger>
                        <DropdownMenuPortal>
                          <DropdownMenuSubContent>
                            ...
                            >
                            <Shield className="h-4 w-4 text-zinc-500 mr-2"/>
                              Guest
                              {
                                member.role === "GUEST" && (
